  ...
  return (
    <details>
      ...
      <li className="mb-10 ml-6">
          ...
          <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 off:text-white">Desktop mode <span className="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded off:bg-blue-200 off:text-blue-800 ml-3">Going live now</span></h3>
