...
export default function MenuNav({ home, search, library }) {
  ...
  return (
    <div className="z-50 flex px-4 items-center justify-around h-12 border-t border-gray-200 bg-white dark:bg-black dark:border-neutral-800 fixed bottom-0 left-0 right-0">
      <Link href="/">
        <a>
