  ...
  return (
    <Link href={`album/${feature.id}`}>
      <a className='w-full lg:flex lg:items-center lg:justify-center'>
        <div className='group transition-colors duration-300 lg:hover:bg-slate-700 lg:bg-slate-800 lg:p-7 my-7 lg:flex lg:items-center w-full lg:justify-center lg:max-w-screen-xl'>
