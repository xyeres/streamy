  ...
  return (
    <>
      ...
      {isPlayerLoaded && (<div onClick={handleOpen} className={isOpen ? "control-bar-hide" : "control-bar-show"}>
        <div className="flex items-center justify-between h-12 drop-shadow border-t border-gray-300 bg-zinc-100">
          ...
          <div className="flex items-center flex-row text-xs">
            <Image width={48} height={48} alt="album cover" src={song.coverUrl} className='w-12 h-12' />
            <div>
      ...
      <div className={isOpen ? "player-show" : "player-hide"}>
        ...
        <div className="mt-24 relative px-8 aspect-square min-w-[320px] min-h-[320px] max-w-md mx-8">
          <Image layout='fill' objectFit='cover' className='my-8' objectPosition="50% 50%" src={song.coverUrl ? song.coverUrl : '/images/lfas-cover.png'} alt="album cover" />
        </div>
