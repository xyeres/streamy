...
export default function PlaylistItem({ song }) {
  ...
  return (
    <li onClick={handleSongClick} className="list-none cursor-pointer hover:bg-gray-100 transition-colors duration-200 flex flex-row text-xs py-2 items-center">
