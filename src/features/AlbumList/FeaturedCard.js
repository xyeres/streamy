...
export default function FeaturedCard({ item }) {
  return (
    <div className="flex cursor-pointer justify-start group hover:bg-opacity-[65%] items-start m-4 sm:mx-0 bg-black bg-opacity-10 p-4 rounded-lg">
      <img src={CoverImage} alt="Featured item artwork" className="rounded-xl w-24 aspect-square" />
