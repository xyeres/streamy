...
function MyApp({ Component, pageProps }) {
  return (
    ...
    <Head>
        ...
        <meta property="og:description" content="Listen to a growing music library of albums and exclusive tracks from United Pursuit and friends" />
        ...
        <meta name="twitter:description" content="Listen to a growing music library of albums and exclusive tracks from United Pursuit and friends" />
